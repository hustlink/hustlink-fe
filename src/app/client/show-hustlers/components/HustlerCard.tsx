// app/client/show-hustlers/components/HustlerCard.tsx
'use client';

import Image from 'next/image';
import Link from 'next/link';
import { FaStar } from 'react-icons/fa';
import { HustlerDetail } from '@/types/entities/hustler';

type Props = {
	hustler: HustlerDetail;
};

export default function HustlerCard({ hustler }: Props) {
	return (
		<Link href={`/client/show-hustlers/${hustler.id}`}>
